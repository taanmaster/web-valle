...
{
    /**
     * SOLICITUDES DIRECCIÓN DE FISCALIZACIÓN - Eventos en Vía Pública
     */
    public function index(Request $request)
    {
        $query = FiscPublicEventRequest::with('user');
        ...
        return view('fiscalizacion.requests.index', [
            'requests' => $requests,
            'breadcrumbTitle' => 'Eventos en Vía Pública',
            'heading' => 'SOLICITUDES DE EVENTOS EN VÍA PÚBLICA',
            'subtitle' => 'Gestión de solicitudes enviadas por los ciudadanos',
            'createRoute' => null,
            'filterRoute' => route('fiscalizacion.public_event_requests.index'),
            'searchPlaceholder' => 'Buscar por folio o responsable...',
            'emptyTitle' => '¡No hay solicitudes de Autorización de Eventos en Vía Pública!',
            ...
            'tramiteLabel' => 'Autorización de Eventos en Vía Pública',
            'showRoute' => 'fiscalizacion.public_event_requests.show',
     ...
     */
    public function show(FiscPublicEventRequest $fiscRequest)
    {
        $fiscRequest->load(['files', 'user']);

        return view('fiscalizacion.public_event_requests.show', compact('fiscRequest'));
    }

    /**
     * Actualizar el estatus de la solicitud
     */
    public function updateStatus(Request $request, FiscPublicEventRequest $fiscRequest)
    {
        ...
        return redirect()->route('fiscalizacion.public_event_requests.show', $fiscRequest);
    }
}
