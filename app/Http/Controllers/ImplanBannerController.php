...
class ImplanBannerController extends Controller
{
    public function index()
    {
        $banners = ImplanBanner::orderBy('priority', 'asc')->paginate(5);

        return view('implan.banners.index', compact('banners'));
    }

    public function create()
    {
        return view('implan.banners.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // Enviar a vista
        return redirect()->route('implan.banners.show', $banner->id);
    }

    public function show($id)
    {
        $banner = ImplanBanner::find($id);

        return view('implan.banners.show')->with('banner', $banner);
    }
    ...
    public function edit($id)
    {
        ...
        return view('implan.banners.edit')->with('banner', $banner);
    }
    ...
    {
        // Guardar datos en la base de datos
        $banner = ImplanBanner::find($request->id);
        ...
        // Enviar a vista
        return redirect()->route('implan.banners.index');
    }
