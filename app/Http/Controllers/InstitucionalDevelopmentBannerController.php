...
class InstitucionalDevelopmentBannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $banner = new InstitucionalDevelopmentBanner;
        ...
        // Enviar a vista
        return redirect()->route('institucional_development.banners.show', $banner->id);
    }
    ...
    {
        // Guardar datos en la base de datos
        $banner = InstitucionalDevelopmentBanner::find($request->id);
        ...
        // Enviar a vista
        return redirect()->route('institucional_development.banners.index');
    }
