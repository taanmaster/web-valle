...
class Review extends Component
{
    ...
    /**
     * Guarda el visto bueno ambiental. El oficio firmado es obligatorio para
     * poder dar por emitido el visto bueno.
     */
    public function saveVistoBueno()
    {
        $this->validate([
            'resolution' => 'required|in:procedente,procedente_con_condicionantes,no_procedente',
            ...
            'technical_notes' => 'consideraciones técnicas ambientales',
            'issued_by' => 'emite (nombre y cargo)',
            'resolution_document' => 'oficio de resolución firmado',
        ]);

        $filepath = 'urban_dev_reviews/'.$this->review->id.'/medio_ambiente/'.$this->cleanFilename($this->resolution_document);
        ...
        Session::flash('success', 'Visto bueno guardado correctamente.');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.environment.urban-dev-requests.review');
    }
}
