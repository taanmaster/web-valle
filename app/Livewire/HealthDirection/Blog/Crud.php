...
class Crud extends Component
{
    ...
    public function save()
    {
        $this->validate([
            ...
            'content_2' => 'nullable',
            'hero_img' => 'nullable',
            'category' => 'required|in:Taller,Campaña,Platica,Evento',
        ...
        if ($this->blog != null) {
            if ($this->hero_img != $this->blog->hero_img) {
                ...
                $imageCoverDir = public_path('images/health_direction/blog/');
                ...
                if ($this->blog->hero_img) {
                    $oldPath = public_path('images/health_direction/blog/' . $this->blog->hero_img);
            ...
            return redirect()->route('health_direction.blog.admin.index');
        } else {
    ...
    {
        return view('health_direction.blog.utilities.crud');
    }
}
