...
<head>
    ...
    <title>Nueva asesoría jurídica agendada — {{ $fecha_cita }} {{ $hora_cita }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Sistema de Gestión — Asesoría Jurídica</p>
        </div>
        ...
        <div class="email-body">
            <p>Hola.</p>
            <p>Se ha registrado una nueva asesoría jurídica.</p>
