...
<head>
    ...
    <title>Nueva solicitud recibida — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-body">
            ...
            <p>Se ha registrado una nueva solicitud en el sistema que requiere tu atención.</p>
            ...
            <p>Accede al sistema para revisar los documentos y registrar tu resolución.</p>
        </div>
