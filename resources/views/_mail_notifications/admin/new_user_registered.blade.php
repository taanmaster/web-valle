...
<head>
    ...
    <title>Nuevo ciudadano registrado en el sistema</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Sistema de Gestión — Portal Municipal</p>
        </div>
        ...
        <div class="email-body">
            ...
            <p>Se ha registrado un nuevo ciudadano en el portal municipal.</p>
