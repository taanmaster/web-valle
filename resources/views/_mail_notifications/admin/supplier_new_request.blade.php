...
<head>
    ...
    <title>Nueva solicitud de proveedor recibida — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-encabezado">
            Nueva solicitud de proveedor pendiente de revisión
        </div>

        <div class="email-body">
            <p>Se ha registrado una nueva solicitud de alta de proveedor en el sistema que requiere tu atención.</p>
            ...
            <p>Accede al sistema para revisar los documentos y dar seguimiento al proceso.</p>
        </div>
