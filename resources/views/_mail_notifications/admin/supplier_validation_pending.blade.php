...
<head>
    ...
    <title>Documentos de proveedor en validación — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Sistema de Gestión — Dirección de Adquisiciones</p>
        </div>

        <div class="email-encabezado">
            Expediente de proveedor listo para validación
        </div>

        <div class="email-body">
            <p>La solicitud del siguiente proveedor ha avanzado al estatus de validación y se encuentra pendiente de tu revisión.</p>
            ...
            <p>Accede al sistema para revisar el expediente documental del proveedor y registrar tu resolución.</p>
        </div>
