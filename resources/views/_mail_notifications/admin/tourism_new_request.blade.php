...
<head>
    ...
    <title>Nueva solicitud de apoyo recibida — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Sistema de Gestión — Dirección de Turismo</p>
        </div>

        <div class="email-encabezado">
            Nueva solicitud de apoyo pendiente
        </div>

        <div class="email-body">
            <p>Hola.</p>
            <p>Se ha registrado una nueva solicitud de apoyo en la Dirección de Turismo.</p>
            ...
            <p>Accede al sistema para revisar los detalles y dar seguimiento a la solicitud.</p>
        </div>
