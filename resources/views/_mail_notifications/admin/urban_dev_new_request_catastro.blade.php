...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Sistema de Gestión — Catastro</p>
        </div>

        <div class="email-encabezado">
            Nueva solicitud de trámite pendiente de captura del predio
        </div>

        <div class="email-body">
            <p>Se ha registrado una nueva solicitud de trámite de desarrollo urbano en el sistema, la cual requiere que captures la información correspondiente al predio.</p>
            ...
            <p>Accede al sistema para capturar la información del predio y continuar con el proceso.</p>
        </div>
