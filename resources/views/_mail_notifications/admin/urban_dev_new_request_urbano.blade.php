{{-- Modelo: UrbanDevRequest --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Nueva solicitud de trámite recibida — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Sistema de Gestión — Desarrollo Urbano</p>
        </div>

        <div class="email-encabezado">
            Nueva solicitud de trámite en espera de información del predio
        </div>

        <div class="email-body">
            <p>Se ha registrado una nueva solicitud de trámite de desarrollo urbano en el sistema.</p>
            ...
            <p>La solicitud se encuentra en espera de que Catastro capture la información del predio correspondiente. Te notificaremos por este medio en cuanto esté disponible.</p>
        </div>
