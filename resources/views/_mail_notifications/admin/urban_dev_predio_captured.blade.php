...
<head>
    ...
    <title>Información del predio capturada — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-encabezado">
            Información del predio capturada por Catastro
        </div>

        <div class="email-body">
            <p>Catastro ha concluido la captura de la información del predio asociada a la siguiente solicitud.</p>
            ...
            <p>Accede al sistema para continuar con el proceso de la solicitud.</p>
        </div>
