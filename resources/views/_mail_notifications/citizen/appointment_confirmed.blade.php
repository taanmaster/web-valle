{{-- Modelo: AppointmentBooking --}}
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tu cita está confirmada — {{ $fecha_cita }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-header">
            ...
            <p class="dept">Asesoría Jurídica</p>
        </div>
        ...
        <div class="email-body">
            ...
            <p>Tu asesoría jurídica ha sido agendada exitosamente. Aquí están los detalles:</p>
            ...
            <div class="info-block">
                <strong>Si tu cita es presencial:</strong>
                Preséntate con identificación oficial vigente y 10 minutos antes de tu horario.
            </div>
        </div>

        <div class="email-footer">
            <strong>H. Ayuntamiento de Valle de Santiago, Guanajuato</strong>
