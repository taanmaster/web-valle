...
<head>
    ...
    <title>Tus documentos fueron aceptados — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-body">
            ...
            <p>Revisamos los documentos de tu solicitud y todo está en orden.</p>
            ...
            <table class="data-table">
                ...
                <tr>
                    <td>Estatus</td>
                    <td><span class="status-badge">Aprobado</span></td>
                </tr>
            </table>

            <p>Gracias por realizar tu trámite con el Gobierno Municipal de Valle de Santiago.</p>
        </div>
