...
<head>
    ...
    <title>Recibimos tus documentos — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-body">
            ...
            <p>Hemos recibido los documentos de tu solicitud.</p>
            ...
            <table class="data-table">
                ...
                <tr>
                    <td>Dependencia</td>
                    <td>Secretaría de Ayuntamiento</td>
                </tr>
                <tr>
            ...
            <p>Nuestro equipo revisará tu documentación. Te notificaremos por este medio cuando haya una actualización.</p>
        </div>
