...
<head>
    ...
    <title>Recibimos tu solicitud de empleo — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-body">
            ...
            <p>Hemos recibido tu solicitud de empleo en el Gobierno Municipal de Valle de Santiago.</p>
            ...
            <div class="folio-note">
                Guarda tu folio — lo necesitarás para dar seguimiento a tu postulación.
            </div>

            <p>El área de Recursos Humanos revisará tu perfil. Si tu solicitud avanza, te contactaremos por este medio o al número que registraste.</p>
        </div>
