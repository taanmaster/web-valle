...
<head>
    ...
    <title>Tu solicitud está lista — realiza tu pago de trámite — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-encabezado">
            Tu solicitud está lista para el pago correspondiente
        </div>

        <div class="email-body">
            <p>Hola,</p>
            <p>Tu expediente ha sido revisado y validado exitosamente. Para concluir tu proceso de alta como proveedor, es necesario realizar el pago del trámite correspondiente.</p>
            ...
            <table class="data-table">
                ...
                <tr>
                    ...
                    <td><span class="status-badge">Pago pendiente</span></td>
                </tr>
            </table>

            <p>Realiza tu pago a través de tu panel de ciudadano. Una vez confirmado el pago, tu proceso continuará de manera automática.</p>
        </div>
