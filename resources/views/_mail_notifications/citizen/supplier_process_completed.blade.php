...
<head>
    ...
    <title>Proceso completo — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-encabezado">
            Tu registro en el padrón de proveedores fue completado exitosamente
        </div>

        <div class="email-body">
            <p>Hola,</p>
            <p>Nos complace informarte que tu proceso de alta ha sido completado satisfactoriamente.</p>
            ...
            <p>Tu registro te permite participar en los procesos de adquisición del Gobierno Municipal.</p>
        </div>
