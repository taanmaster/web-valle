...
<head>
    ...
    <title>Tu solicitud fue aprobada — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-body">
            <p>Hola,</p>
            <p>Revisamos tu expediente y nos complace informarte que tu solicitud de alta como proveedor ha sido aprobada.</p>
            ...
            <table class="data-table">
                ...
                <tr>
                    <td>Estatus</td>
                    <td><span class="status-badge">Aprobada</span></td>
                </tr>
            </table>

            <p>En breve recibirás más información sobre los siguientes pasos de tu proceso ante la Dirección de Adquisiciones.</p>
        </div>
