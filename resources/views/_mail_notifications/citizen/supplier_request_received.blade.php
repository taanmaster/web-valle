...
<head>
    ...
    <title>Recibimos tu solicitud de alta como proveedor — Folio {{ $folio }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="email-encabezado">
            Solicitud de alta de proveedor recibida
        </div>

        <div class="email-body">
            <p>Hola, <strong>{{ $nombre_proveedor }}</strong>.</p>
            <p>Hemos recibido tu solicitud de registro como proveedor ante la Dirección de Adquisiciones del Municipio de Valle de Santiago.</p>
            ...
            <p>Nuestro equipo revisará tu documentación. Te notificaremos por este medio cuando haya una actualización en tu proceso.</p>
            <p>Guarda tu número de folio — lo necesitarás para dar seguimiento a tu solicitud.</p>
        </div>
