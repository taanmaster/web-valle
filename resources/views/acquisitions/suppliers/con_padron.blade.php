                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-1 fw-bold">
                                <i class="fas fa-star text-warning me-2"></i> Proveedores CON Padrón
                            </h3>
                            <p class="text-muted mb-0">
                                <i class="fas fa-calendar-check me-1"></i>
                                Proveedores con refrendo aprobado del año actual
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('acquisitions.suppliers.con_padron') }}" class="btn btn-outline-secondary btn-lg">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="py-4">
                                                ...
                                                <p class="text-muted mb-0">No hay proveedores con padrón registrados</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
