    ...
    <div class="main-content">
        <div class="row align-items-center mb-4">
            <div class="col-md-8 text-start">
                <h4 class="mb-0">
                    <ion-icon name="alert-circle-outline"></ion-icon> Proveedores SIN Padrón
                </h4>
                <p class="text-muted">Proveedores sin refrendo aprobado del año actual</p>
            </div>
        </div>
                            ...
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ route('acquisitions.suppliers.sin_padron') }}" class="btn btn-secondary">
                                ...
                                <tbody>
                                    @forelse($suppliers as $supplier)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-warning">{{ $supplier->endorsements->count() }} refrendo(s)</span>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-5">
                                                ...
                                                <p class="text-muted mt-3 mb-0">No hay proveedores sin padrón registrados</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
