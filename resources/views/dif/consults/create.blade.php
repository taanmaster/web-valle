...
@section('content')
    ...
    @slot('title') Nueva Consulta @endslot
    @endcomponent
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Crear Nueva Consulta Médica</h4>
                        <div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dif.consults.store') }}">
                        @csrf
                        ...
                        <h5 class="mb-3">Información de la Consulta</h5>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="consult_num" id="consult_num" class="form-control" 
                                            value="{{ old('consult_num', $consultNum) }}" readonly>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="consult_date" id="consult_date" class="form-control" 
                                           value="{{ old('consult_date', date('Y-m-d')) }}" required readonly>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="consult_type_id" id="consult_type_id" class="form-control">
                                            ...
                                            @foreach($consultTypes as $type)
                                                <option value="{{ $type->id }}" {{ old('consult_type_id') == $type->id ? 'selected' : '' }}>
                                                    {{ $type->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        <label for="consult_description">Notas <span class="text-info">(Opcional)</span></label>
                                        <textarea name="consult_description" id="consult_description" class="form-control" 
                                                rows="4" placeholder="Ingresa los detalles de la consulta, diagnóstico, observaciones, etc.">{{ old('consult_description') }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('dif.consults.index') }}" class="btn btn-secondary">
...
$(document).ready(function() {
    ...
    if (typeof $.fn.select2 !== 'undefined') {
        $('#doctor_id, #consult_type_id').select2({
