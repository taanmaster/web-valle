...
@section('title')Movimientos de Salida @endsection
@section('content')
<!-- this is breadcrumbs -->
...
@slot('title') Movimientos de Salida @endslot
@endcomponent
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('dif.stock_movements.outbound') }}">
                                    <div class="row">
                                        <div class="col-md-3">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-2">
                                            @if(request()->hasAny(['date_from', 'date_to', 'medication_id', 'search']))
                                                <a href="{{ route('dif.stock_movements.outbound') }}" class="btn btn-outline-secondary w-100">
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-info text-white">
                                        <div class="card-body text-center">
                                            ...
                                            <p class="mb-0">Unidades Entregadas</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($movement->external_reference)
                                                        <strong>{{ $movement->external_reference }}</strong>
                                                    @else
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="{{ route('dif.stock_movements.receipt', $movement->id) }}" 
                                                           class="btn btn-sm btn-success" title="Generar Recibo PDF" target="_blank">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <h5 class="text-muted">No hay movimientos de salida registrados</h5>
                                <p class="text-muted">
                                    @if(request()->hasAny(['date_from', 'date_to', 'medication_id', 'search']))
                                        No se encontraron movimientos de salida con los filtros aplicados.
                                    @else
                                        Registra el primer movimiento de salida para comenzar a gestionar las entregas.
                                    @endif
                                </p>
                                <div class="d-flex gap-2 justify-content-center">
                                    @if(request()->hasAny(['date_from', 'date_to', 'medication_id', 'search']))
                                        <a href="{{ route('dif.stock_movements.outbound') }}" class="btn btn-outline-secondary">
                                            <i class="fas fa-times"></i> Limpiar Filtros
                                        </a>
                                    @endif
                                    <a href="{{ route('dif.stock_movements.create') }}" class="btn btn-danger">
