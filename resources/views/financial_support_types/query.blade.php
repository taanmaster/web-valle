                    ...
                    <div class="col-lg-8 d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">
                                ...
                                @endif
                                <span class="badge bg-info">{{ $financial_support_types->count() }} resultado(s)</span>
                            </p>
                        </div>
                    </div>
                ...
                <form role="search" action="{{ route('back.financial_support_types.query') }}" class="row g-3 align-items-end">
                    <div class="col-md-10">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="search" name="query" value="{{ Request::input('query') }}" placeholder="Nombre del tipo de apoyo...">
                        </div>
                    </div>
                    <div class="col-md-2">
