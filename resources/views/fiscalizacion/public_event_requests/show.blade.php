...
@slot('li_3') <a href="{{ route('fiscalizacion.public_event_requests.index') }}">Solicitudes</a> @endslot
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="mb-1">Autorización de Eventos en Vía Pública</p>
        ...
        <div class="row">
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 mb-3">
                                                ...
                                                <p class="mb-0">{{ $fiscRequest->exact_location }}</p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <small class="text-muted">¿Requiere cierre de calles?:</small>
                                                <p class="mb-0">{{ $fiscRequest->requires_street_closure ? 'Sí' : 'No' }}</p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <small class="text-muted">¿Será realizado en una comunidad?:</small>
                                                <p class="mb-0">{{ $fiscRequest->is_in_community ? 'Sí' : 'No' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('fiscalizacion.public_event_requests.update_status', $fiscRequest) }}">
                            @csrf
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body d-flex flex-column gap-2">
                        <a href="{{ route('fiscalizacion.public_event_requests.index') }}" class="btn btn-secondary">
