                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" id="citizenProfileTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="{{ route('citizen.profile.index') }}" id="inicio-tab"
                                    role="tab">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-0">
                                        Bienvenido al portal ciudadano. Aquí podrás realizar solicitudes, dar seguimiento a
                                        trámites,
