                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Buscar por número, RFC o nombre comercial..." id="searchInput">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    ...
                                                    <p class="text-muted mb-1">
                                                        <i class="bx bx-calendar"></i> Creada: {{ $request->created_at->format('d/m/Y') }}
                                                ...
                                                <div class="col-md-2 text-center">
                                                    ...
                                                    @if($request->created_at->diffInDays() <= 7)
                                                        <br><small class="text-success"><i class="bx bx-time"></i> Reciente</small>
                                                    @endif
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="request_num" name="request_num" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="catastral_num" name="catastral_num" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="legal_representative_father_last_name" class="form-label">Apellido Paterno *</label>
                                <input type="text" class="form-control" id="legal_representative_father_last_name" name="legal_representative_father_last_name" required>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="legal_representative_mother_last_name" class="form-label">Apellido Materno *</label>
                                <input type="text" class="form-control" id="legal_representative_mother_last_name" name="legal_representative_mother_last_name" required>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="legal_representative_office_phone" class="form-label">Teléfono Oficina *</label>
                                <input type="tel" class="form-control" id="legal_representative_office_phone" name="legal_representative_office_phone" required>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="legal_representative_mobile_phone" class="form-label">Teléfono Móvil *</label>
                                <input type="tel" class="form-control" id="legal_representative_mobile_phone" name="legal_representative_mobile_phone" required>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="legal_representative_personal_phone" class="form-label">Teléfono Personal *</label>
                                <input type="tel" class="form-control" id="legal_representative_personal_phone" name="legal_representative_personal_phone" required>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="legal_representative_email" class="form-label">Email Representante *</label>
                                <input type="email" class="form-control" id="legal_representative_email" name="legal_representative_email" required>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="legal_representative_ownership_document" class="form-label">Documento de Propiedad *</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_legal_cause_addon" name="establishment_legal_cause_addon">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="establishment_good_faith_clause" class="form-label">Cláusula de Buena Fe *</label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_address_street" name="establishment_address_street" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_address_number" name="establishment_address_number" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_address_neighborhood" name="establishment_address_neighborhood" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_address_municipality" name="establishment_address_municipality" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_address_state" name="establishment_address_state" required>
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="establishment_address_postal_code" class="form-label">Código Postal *</label>
                                <input type="text" class="form-control" id="establishment_address_postal_code" name="establishment_address_postal_code" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="establishment_use" name="establishment_use">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="commercial_name" name="commercial_name" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="aprox_investment" name="aprox_investment" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="jobs_to_generate" name="jobs_to_generate" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="operation_start_date" name="operation_start_date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="business_hours" name="business_hours" placeholder="Ej: 8:00 - 18:00">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="is_location_in_operation" name="is_location_in_operation" value="1">
...
@push('scripts')
    ...
    <script>
        ...
        function fillTestData() {
            ...
            document.getElementById('description').value = 'Solicitud de permiso para establecimiento comercial de prueba. Esta es una descripción de ejemplo para fines de testing del sistema SARE.';
