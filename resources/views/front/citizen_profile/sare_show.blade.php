...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function loadDocumentChecklist() {
            ...
            const requiredDocs = [
                { slug: 'documento-propiedad', title: 'Documento que acredite propiedad del inmueble' },
                { slug: 'id-solicitante', title: 'Identificación oficial del solicitante' },
                { slug: 'id-propietario', title: 'Identificación oficial del propietario' },
                { slug: 'comprobante-domicilio', title: 'Comprobante de domicilio (no mayor a 2 meses)' },
                { slug: 'pago-predial', title: 'Pago predial del presente año' }
            ];
            ...
            requiredDocs.forEach(doc => {
                ...
                const statusClass = isUploaded ? 'border-success bg-success bg-opacity-10' : 'border-secondary';
            ...
            // Documentos adicionales para persona moral
            const moralDocs = [
                { slug: 'acta-constitutiva', title: 'Acta constitutiva de la Empresa' },
                { slug: 'poder-representante', title: 'Poder simple o notariado del representante legal' }
            ];
            ...
            moralDocs.forEach(doc => {
                const isUploaded = uploadedFilesByType[doc.slug];
                const statusClass = isUploaded ? 'border-success bg-success bg-opacity-10' : 'border-warning border-opacity-50';
        ...
        function mapFileNameToDocType(fileName, documentName = '') {
            ...
            if (nameLower.includes('propiedad') || nameLower.includes('escritura') || nameLower.includes('titulo')) {
                return 'documento-propiedad';
            }
        ...
        function updateDocumentSelect() {
            ...
            const allDocOptions = [
                { value: 'documento-propiedad', text: 'Documento que acredite propiedad del inmueble' },
                { value: 'id-solicitante', text: 'Identificación oficial del solicitante' },
                { value: 'id-propietario', text: 'Identificación oficial del propietario' },
                { value: 'comprobante-domicilio', text: 'Comprobante de domicilio' },
                { value: 'pago-predial', text: 'Pago predial del presente año' },
                { value: 'acta-constitutiva', text: 'Acta constitutiva de la Empresa' },
                { value: 'poder-representante', text: 'Poder del representante legal' }
            ];
        ...
        function updateChecklistItem(docSlug, isUploaded) {
            ...
            if (item) {
                ...
                if (isUploaded) {
                    ...
                    item.className = 'checklist-item border rounded p-2 mb-2 border-success bg-success bg-opacity-10';
                ...
                if (confirm('¿Estás seguro de que quieres eliminar este archivo?')) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            const remainingFiles = document.querySelectorAll('.uploaded-file-item');
