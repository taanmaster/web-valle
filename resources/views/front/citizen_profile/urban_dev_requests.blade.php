                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Buscar por tipo de trámite o descripción..." id="searchInput">
                        ...
                        @if($urbanDevRequests->count() > 0)
                            @foreach($urbanDevRequests as $request)
                                @php
                                    ...
                                    $progressPercentage = $totalDocuments > 0 ? round(($uploadedDocuments / $totalDocuments) * 100) : 0;
                                ...
                                <div class="col-lg-6 col-xl-4 request-item mb-4" 
                                     data-status="{{ $request->status }}" 
                                     data-type="{{ $request->request_type }}"
                                     data-search="{{ strtolower($request->getRequestTypeLabelAttribute() . ' ' . ($request->description ?? '')) }}">
                                    <div class="card h-100 shadow-sm">
                                        <div class="card-header bg-{{ $request->getStatusColorAttribute() }} text-white">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h6 class="mb-0">
                                                    <ion-icon name="document-text-outline"></ion-icon>
                                                    Solicitud #{{ $request->id }}
                                                </h6>
                                                <span class="badge bg-white text-{{ $request->getStatusColorAttribute() }} small">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <small class="text-muted">
                                                    <ion-icon name="calendar-outline"></ion-icon> Creada: {{ $request->created_at->format('d/m/Y') }}
                                                    <span class="mx-2">|</span>
                                                    <ion-icon name="time-outline"></ion-icon> {{ $request->created_at->diffForHumans() }}
                                                </small>
                                            </div>
                                            ...
                                            <div class="bg-light rounded p-3 mb-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span class="small">{{ $uploadedDocuments }}/{{ $totalDocuments }}</span>
                                                </div>
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <small class="text-{{ $progressColor }}">
                                                        <ion-icon name="document-outline"></ion-icon> {{ $uploadedDocuments }} subidos
                                                    </small>
                                                    @if($totalDocuments - $uploadedDocuments > 0)
                                                        <small class="text-muted">
                                                            <ion-icon name="document-outline"></ion-icon> {{ $totalDocuments - $uploadedDocuments }} pendientes
                                                        </small>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="row text-center">
                                                    <div class="col-4">
                                                        <div class="p-2">
                                                            <div class="mb-1 {{ $progressPercentage > 0 ? 'text-success' : 'text-muted' }}" style="font-size: 1.2rem;">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="p-2">
                                                            <div class="mb-1 {{ $progressPercentage >= 50 ? 'text-warning' : 'text-muted' }}" style="font-size: 1.2rem;">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="p-2">
                                                            <div class="mb-1 {{ $progressPercentage == 100 ? 'text-success' : 'text-muted' }}" style="font-size: 1.2rem;">
                        ...
                        @else
                            ...
                            <div class="col-md-12" id="emptyState">
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted">Crea tu primera solicitud de desarrollo urbano para empezar el trámite</p>
                                    <a href="{{ route('citizen.urban_dev.create') }}" class="btn btn-primary">
                                        <ion-icon name="add-circle-outline"></ion-icon> Nueva Solicitud
                                    </a>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="text-muted mb-0">
                                        Mostrando {{ $urbanDevRequests->firstItem() }} a {{ $urbanDevRequests->lastItem() }} 
