        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-12">
                <div class="card card-image card-image-banner justify-content-center wow fadeInUp">
                    <img class="card-img-top" src="{{ asset('contraloria/contra-46.jpg') }}" alt="">
                    ...
                    <div class="card-content text-center w-100">
                        ...
                        <p class="p mb-0 ms-auto me-auto" style="width: 70%;">La declaración patrimonial es el documento
                            mediante el cual los servidores públicos manifiestan los bienes muebles e inmuebles que integran
                            su patrimonio con la finalidad de transparentar su evolución patrimonial y su congruencia que
                            tiene con los ingresos y egresos percibidos en un año.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="declaration-timeline">
                    <div class="timeline-item wow fadeInUp" data-step="1">
                        ...
                        <div class="timeline-content">
                            ...
                            <p class="justify-p mb-0">Dentro de los sesenta días naturales siguientes a la toma de posesión
                                con motivo del: a) Ingreso al servicio público por primera vez; o b) Reingreso al servicio
                                público después de sesenta días naturales de la conclusión de su último encargo.</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item wow fadeInUp" data-step="3">
                        ...
                        <div class="timeline-content">
                            ...
                            <p class="justify-p mb-0">Dentro de los sesenta días naturales siguientes a la conclusión del
                                cargo.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 mb-3 ps-3">
                ...
                <div class="alert-box danger-alert wow fadeInUp">
                    ...
                    <div class="alert-content">
                        <p class="justify-p mb-0">En caso de que no realices este trámite, se iniciará un procedimiento de
                            responsabilidad administrativa por la omisión a la presentación de tu declaración; una vez
                            realizada la investigación correspondiente y en caso de existir la falta, se substanciará y
                            resolverá conforme a la Ley.</p>
                    </div>
                </div>
                ...
                <div class="card card-normal wow fadeInUp mt-4">
                    <div class="card-content">
                        ...
                        <p class="justify-p mb-3">Accede al sistema DeclaraNet para realizar tu declaración patrimonial de
                            manera electrónica.</p>
                        <a href="https://declaranetmunicipios.sh.guanajuato.gob.mx/" target="_blank"
        ...
        `;
            ...
            timelineItems.forEach((item, index) => {
                ...
                const counterObserver = new IntersectionObserver((entries) => {
                    entries.forEach(entry => {
                        if (entry.isIntersecting && number.textContent === targetNumber
                            .toString()) {
