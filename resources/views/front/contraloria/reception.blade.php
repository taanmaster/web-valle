            ...
            <div class="col-md-12">
                <div class="card card-image card-image-banner justify-content-center wow fadeInUp">
                    ...
                    <div class="card-content text-center w-100">
                        ...
                        <p class="p mb-0 ms-auto me-auto" style="width: 70%;">La entrega-recepción es el procedimiento administrativo obligatorio, mediante el cual los servidores públicos entregan, a quien los sustituyan o reciba de manera provisional, los recursos humanos, materiales, técnicos y financieros que le hayan sido asignados; esto mediante el documento denominado como Acta Entrega - Recepción.</p>
                    </div>
                </div>
            </div>
        </div>
