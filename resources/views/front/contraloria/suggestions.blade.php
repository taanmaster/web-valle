    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="card card-image card-image-banner justify-content-center wow fadeInUp">
                    ...
                    <div class="card-content text-center w-100">
                        ...
                        <p class="p mb-0 ms-auto me-auto" style="width: 70%;">El área de quejas, denuncias y sugerencias de la Contraloría Municipal de Valle de Santiago, Guanajuato es la encargada de establecer y operar el sistema de quejas, denuncias y sugerencias de la administración pública municipal.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="card card-normal wow fadeInUp" style="background: linear-gradient(135deg, #f5f5f5 0%, #eeeeee 100%);">
                    <div class="card-content">
                        ...
                        <p class="mb-4" style="font-size: 1.05rem; line-height: 1.8; text-align: justify;">En caso de no encontrarlos o ser insuficientes se decreta acuerdo de conclusión y archivo sin perjuicio de que pueda abrirse nuevamente la investigación al encontrarse nuevos elementos.</p>
                        
                        <p class="mb-0" style="font-size: 1.05rem; line-height: 1.8; text-align: justify;">Así mismo, si no se encuentran elementos suficientes, pero se encuentra un área de oportunidad se elabora acuerdo de conclusión y archivo con recomendación.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-12 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div style="min-width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: bold; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);">1</div>
                                    <div>
                                        <p class="mb-0" style="font-size: 1.05rem; line-height: 1.8;">Llenar el formulario con los datos correspondientes</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div style="min-width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: bold; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);">2</div>
                                    <div>
                                        <p class="mb-0" style="font-size: 1.05rem; line-height: 1.8;">Los datos marcados con asterisco son obligatorios</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div style="min-width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: bold; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);">3</div>
                                    <div>
                                        <p class="mb-0" style="font-size: 1.05rem; line-height: 1.8;">Es necesario que proporcione sus datos personales, no obstante, tiene el derecho a que se mantengan ocultos ante el servidor público del que se realiza la queja/denuncia</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div style="min-width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: bold; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);">4</div>
                                    <div>
                                        <p class="mb-0" style="font-size: 1.05rem; line-height: 1.8;">Puede subir algún tipo de evidencia en foto, audio o video en cualquiera de los formatos listados en esta página. Sólo puede subir un archivo de evidencias</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div style="min-width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; font-weight: bold; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);">5</div>
                                    <div>
                                        <p class="mb-0" style="font-size: 1.05rem; line-height: 1.8;">Al enviar la información de la queja/denuncia se generará un folio el cual tiene que conservar para consultar el status en que se encuentra</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <a href="{{ route('contraloria.privacy_notice') }}" class="btn btn-primary btn-xl">Haz clic y consulta nuestro Aviso de Privacidad</a>
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 mb-3">
                <div class="card card-normal wow fadeInUp h-100 text-center" style="border: 2px solid #e0e0e0; transition: all 0.3s ease;">
                    <div class="card-content d-flex flex-column align-items-center justify-content-center" style="min-height: 200px;">
                        <div style="width: 70px; height: 70px; background: #f5f5f5; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 15px;">
            ...
            <div class="col-md-3 mb-3">
                <div class="card card-normal wow fadeInUp h-100 text-center" style="border: 2px solid #e0e0e0; transition: all 0.3s ease;">
                    <div class="card-content d-flex flex-column align-items-center justify-content-center" style="min-height: 200px;">
                        <div style="width: 70px; height: 70px; background: #f5f5f5; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 15px;">
                            <ion-icon name="information-circle-outline" style="font-size: 2.5rem; color: #9c27b0;"></ion-icon>
                        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4 mb-3">
                <div class="card card-normal wow fadeInUp h-100 text-center" style="border: 2px solid #e0e0e0; transition: all 0.3s ease;">
                    <div class="card-content d-flex flex-column align-items-center justify-content-center" style="min-height: 200px;">
                        <div style="width: 70px; height: 70px; background: #e3f2fd; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 15px;">
            ...
            <div class="col-md-4 mb-3">
                <div class="card card-normal wow fadeInUp h-100 text-center" style="border: 2px solid #e0e0e0; transition: all 0.3s ease;">
                    <div class="card-content d-flex flex-column align-items-center justify-content-center" style="min-height: 200px;">
                        <div style="width: 70px; height: 70px; background: #e8f5e9; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 15px;">
            ...
            <div class="col-md-4 mb-3">
                <div class="card card-normal wow fadeInUp h-100 text-center" style="border: 2px solid #e0e0e0; transition: all 0.3s ease;">
                    <div class="card-content d-flex flex-column align-items-center justify-content-center" style="min-height: 200px;">
                        <div style="width: 70px; height: 70px; background: #fff3e0; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 15px;">
