                                ...
                                <div class="card-body p-0">
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="mb-0 fw-semibold">{{ $worker->employee_number ?? 'N/D' }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="mb-0 fw-semibold">Fiscalización</p>
                                                    </div>
                                                </div>
                                            </div>

                                            <!-- Fecha de Emisión -->
                                            @if($worker->issue_date)
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-shrink-0">
                                    ...
                                    <div class="border-top p-3 text-center bg-light">
                                        <small class="text-muted">
                                            ...
                                            Gobierno Municipal de Valle de Santiago &middot; <strong>FISCALIZACIÓN</strong>
                                        </small>
                                    </div>
                                </div>
                            </div>
