                ...
                <div class="card card-normal wow fadeInUp">
                    <div class="w-100">
                        @switch($gazette->type)
                            ...
                            @case('document')
                                <p class="small-uppercase mb-0">Documentos Publicados H. Ayuntamiento 2024-2027</p>
                            @break
                        ...
                        <div class="d-flex gap-3">
                            <p class="d-flex align-items-center gap-2"><ion-icon name="document-text-outline"></ion-icon>
                                Acta {{ $gazette->document_number }}</p>
                            <p class="d-flex align-items-center gap-2"><ion-icon name="calendar-outline"></ion-icon> Fecha
                                de Reunión: {{ Carbon\Carbon::parse($gazette->meeting_date)->translatedFormat('d F Y') }}
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="fw-semibold text-uppercase"
                                                style="font-size: 0.75rem; letter-spacing: 0.5px;">Documento</th>
                                            <th class="fw-semibold text-uppercase text-center"
                                                style="font-size: 0.75rem; letter-spacing: 0.5px;">Tipo</th>
                                            <th class="fw-semibold text-uppercase text-center"
                                                style="font-size: 0.75rem; letter-spacing: 0.5px;">Tamaño</th>
                                            <th class="fw-semibold text-uppercase text-center"
                                                style="font-size: 0.75rem; letter-spacing: 0.5px;">Acción</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($gazette->files as $file)
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <ion-icon name="document-text-outline"
                                                            style="font-size: 1.5rem; color: #6c757d;"></ion-icon>
                                                        <div>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="badge bg-secondary text-uppercase">{{ $file->file_extension ?? 'PDF' }}</span>
                                                </td>
