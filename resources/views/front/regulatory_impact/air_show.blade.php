            ...
            <div class="card card-normal wow fadeInUp mb-4">
                <div class="card-body w-100">
                    <div class="d-flex align-items-start w-100 justify-content-between">
                        <div>
                            <span class="badge bg-warning text-dark fs-6 fw-bold">{{ $record->folio }}</span>
                            <div class="mt-3">
                                <h4 class="fw-bold mb-1">{{ $record->nombre_propuesta }}</h4>
                                <p class="text-muted mb-0 small">Análisis de Impacto Regulatorio · {{ $record->dependency->name ?? '' }}</p>
                            </div>
                        </div>
            ...
            <div class="card card-normal wow fadeInUp mb-4">
                <div class="card-body w-100">
                    <h5 class="fw-bold mb-3">
                        <ion-icon name="document-text-outline" class="me-2"></ion-icon> Formato de Solicitud
                    </h5>
