<nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded-pill shadow mb-4">
    <div class="container-fluid px-4">
        ...
        <a class="navbar-brand fw-bold text-white d-flex align-items-center gap-2"
            href="{{ route('secretary_of_assistance.index') }}">
            <ion-icon name="library-outline"></ion-icon> Secretaría de Ayuntamiento
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link text-white fw-medium px-3 py-2 rounded-pill mx-1  d-flex align-items-center gap-2 {{ request()->routeIs('contraloria.index') ? 'bg-white bg-opacity-25' : '' }}"
                        href="{{ route('secretary_of_assistance.index') }}">
