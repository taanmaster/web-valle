                ...
                <div class="card wow fadeInUp">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="mb-0">
                                <ion-icon name="file-tray-full-outline"></ion-icon> Mis Solicitudes — Autorización de Eventos Particulares
                            </h5>
                        ...
                        {{-- Filtros --}}
                        <form method="GET" action="{{ route('citizen.fisc.private_event.index') }}" class="row g-2 mb-4">
                            <div class="col-md-4">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-8">
                                                        ...
                                                        <p class="text-muted mb-0">
                                                            ...
                                                            <ion-icon name="business-outline"></ion-icon> {{ $req->venue }}
                                                        </p>
                                                    </div>
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="mb-0 text-muted">Aún no tienes solicitudes de Autorización de Eventos Particulares.</p>
                            </div>
                        @endif
                    </div>
                </div>
