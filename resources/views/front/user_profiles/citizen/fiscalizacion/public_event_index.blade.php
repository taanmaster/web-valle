                ...
                <div class="card wow fadeInUp">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h5 class="mb-0">
                                <ion-icon name="file-tray-full-outline"></ion-icon> Mis Solicitudes — Autorización de Eventos en Vía Pública
                            </h5>
                        ...
                        {{-- Filtros --}}
                        <form method="GET" action="{{ route('citizen.fisc.public_event.index') }}" class="row g-2 mb-4">
                            <div class="col-md-4">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-8">
                                                        ...
                                                        <p class="text-muted mb-0">
                                                            <ion-icon name="calendar-outline"></ion-icon> Evento: {{ $req->event_date->format('d/m/Y') }}
                                                            <span class="mx-2">|</span>
                                                            <ion-icon name="location-outline"></ion-icon> {{ $req->exact_location }}
                                                        </p>
                                                    </div>
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="mb-0 text-muted">Aún no tienes solicitudes de Autorización de Eventos en Vía Pública.</p>
                            </div>
                        @endif
                    </div>
                </div>
