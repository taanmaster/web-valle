                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="emailNotifications">
                                                        ...
                                                        <br><small class="text-muted">Recibir actualizaciones de solicitudes
                                                            por correo</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="smsNotifications">
                                                        ...
                                                        <br><small class="text-muted">Recibir mensajes de texto
                                                            importantes</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="pushNotifications">
                                                        ...
                                                        <br><small class="text-muted">Notificaciones en tiempo real en el
                                                            navegador</small>
                                                    </label>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-muted">Tu cuenta será desactivada temporalmente. Podrás reactivarla contactando al
                        soporte.</p>
                </div>
