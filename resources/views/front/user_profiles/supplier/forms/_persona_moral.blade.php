<div class="row g-3">
    ...
    <div class="col-md-6">
        <label for="legal_representative" class="form-label">Apoderado Legal y/o Representante</label>
    ...
    <div class="col-md-6">
        <label for="social_media" class="form-label">Redes Sociales <span class="text-muted">(si aplica)</span></label>
        <input type="text" class="form-control @error('social_media') is-invalid @enderror"
               id="social_media" name="social_media"
               value="{{ old('social_media', $supplier->social_media) }}">
        @error('social_media')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
