                ...
                <div class="modal-body pd-25">
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" name="name" id="gazette_name" class="form-control" required=""
                                autocomplete="off">
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="file" name="document" id="document_file" class="form-control" required=""
                                autocomplete="off">
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info">
                                ...
                                <p class="mb-0 mt-1"><strong>Para archivos grandes (>8MB):</strong> Se usará subida por
                                    fragmentos para mejor rendimiento.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        async function uploadChunks(file, uploadId, totalChunks) {
            for (let i = 0; i < totalChunks; i++) {
                ...
                if (!response.ok) {
                    const errorData = await response.json().catch(() => ({}));
                    throw new Error(
                        `Error en fragmento ${i + 1}: ${errorData.error || 'Error desconocido'}`);
                }
