...
<div class="dropdown-menu">
    <form class="form-horizontal p-4" role="search" action="{{ route('back.gazette.query') }}">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="contain">Que contenga los términos...</label>
                    <input class="form-control" type="search" name="query" placeholder="Número de Folio o Titulo de la publicación">
                </div>
            </div>
