    ...
    <div class="main-content">
        <div class="row align-items-center mb-4">
            <div class="col text-start">
                <a href="{{ route('headerbands.create') }}" class="btn btn-primary">Agregar Elemento</a>
            </div>
        </div>
                ...
                <div class="box">
                    <div class="box-body"> 
                        <div class="text-center" style="padding:80px 0px 100px 0px;">
                            ...
                            <a href="{{ route('headerbands.create') }}" class="btn btn-sm btn-primary btn-uppercase"><i class="fas fa-plus"></i> Agregar Elemento</a>
                        </div>       
                    </div>
                </div>
            </div>
