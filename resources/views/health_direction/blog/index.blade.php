        ...
        <div class="main-content">
            <div class="row align-items-center mb-4">
                <div class="col text-start">
                    <a href="{{ route('health_direction.blog.admin.create') }}" class="btn btn-primary">Nueva Entrada</a>
                </div>
            </div>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="text-center" style="padding:80px 0px 100px 0px;">
                                    ...
                                    <a href="{{ route('health_direction.blog.admin.create') }}"
            ...
            @else
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <livewire:health-direction.blog.entries-table />
                    </div>
                </div>
