...
<div class="row layout-spacing">
    <div class="main-content">
        ...
        <form method="POST" wire:submit="save" enctype="multipart/form-data">
            ...
            <div class="row m-3">
                <div class="col-md-6 mb-3">
                    <label for="writer" class="form-label">Escrito por...</label>
                    <input type="text" class="form-control" name="writer" wire:model="writer"
                        @if ($mode == 1) disabled @endif>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" name="category" wire:model.live="category" required
                        @if ($mode == 1) disabled @endif>
                        <option value="">Seleccionar categoría</option>
                        <option value="Taller">Taller</option>
                        <option value="Campaña">Campaña</option>
                        <option value="Platica">Pláctica</option>
        ...
        @if ($mode == 2)
            ...
            <div class="col-md-12">
                <form action="{{ route('dropzone.health_direction.blog.upload', $blog->id) }}" method="POST"
    ...
    @push('scripts')
        ...
        <script>
            ...
            const myDropzone = new Dropzone("#dropzoneForm", {
                url: "{{ route('dropzone.health_direction.blog.upload', $blog->id) }}",
                headers: {
            ...
            function load_images() {
                $.ajax({
                    url: "{{ route('dropzone.health_direction.blog.fetch', $blog->id) }}",
            ...
            $(document).on('click', '.remove_file', function() {
                ...
                $.ajax({
                    url: "{{ route('dropzone.health_direction.blog.delete') }}",
                    type: 'POST',
                    data: {
