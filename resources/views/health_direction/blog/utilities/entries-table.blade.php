    ...
    <div class="row">
        @foreach ($blogs as $blog)
            <div class="col-md-6 mb-4">
                <div class="card">
                    <img src="{{ asset('images/health_direction/blog/' . $blog->hero_img) }}" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex mt-3 w-100 justify-content-between align-items-center">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('health_direction.blog.admin.edit', $blog->id) }}"
                                    class="btn btn-sm btn-outline-secondary"><i class='bx bx-edit'></i> Editar</a>
                                <form method="POST" action="{{ route('health_direction.blog.admin.destroy', $blog->id) }}"
