...
<style>
    .ip-upload-box { cursor: pointer; min-height: 70px; border: 1px solid #dee2e6; border-radius: 8px; background: #f8f9fa; transition: border-color .2s, background .2s; }
    .ip-upload-box:hover { border-color: #adb5bd; background: #f1f3f5; }
    ...
    <div class="main-content">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            <h4 class="fw-bold mb-0">
                @if ($mode === 0) Nueva Entrada
                @elseif ($mode === 1) Ver Entrada
                @else Editar Entrada
                @endif
            </h4>
        </div>
        ...
        <form method="POST" wire:submit="save" enctype="multipart/form-data">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row align-items-start mb-3">
                        ...
                        <div class="col-md-9" wire:ignore>
                            <input id="ip_content_1" type="hidden" value="{{ $content_1 }}">
                            <trix-editor input="ip_content_1" id="trix-ip-content_1"
                    ...
                    <div class="row align-items-start mb-3">
                        ...
                        <div class="col-md-9" wire:ignore>
                            <input id="ip_content_2" type="hidden" value="{{ $content_2 }}">
                            <trix-editor input="ip_content_2" id="trix-ip-content_2"
                                @if ($mode === 1) disabled @endif></trix-editor>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-start mb-3">
                        ...
                        <div class="col-md-9">
                            @if ($mode === 1)
                                ...
                                @endif
                            @else
                                <label class="ip-upload-box d-flex align-items-center justify-content-center gap-2 w-100 p-3">
            ...
            <div class="d-flex justify-content-center align-items-center gap-3 mb-4">
                <a href="{{ route('identity_program.admin.index') }}" class="btn btn-secondary px-4">
                ...
                @else
                    <a href="{{ route('identity_program.admin.edit', $entry->id) }}" class="btn btn-primary px-4">
                        <i class="bx bx-edit"></i> Editar entrada
                    </a>
                @endif
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const e1 = document.querySelector('#trix-ip-content_1');
        const e2 = document.querySelector('#trix-ip-content_2');

        if (e1) {
            e1.addEventListener('trix-change', function () {
                Livewire.dispatch('updateIdentityProgramContent1', {
                    payload: document.querySelector('#ip_content_1').value
                });
            });
        }
        if (e2) {
            e2.addEventListener('trix-change', function () {
                Livewire.dispatch('updateIdentityProgramContent2', {
                    payload: document.querySelector('#ip_content_2').value
                });
            });
        }
    });
