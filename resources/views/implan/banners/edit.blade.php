                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <select class="form-control" name="position" required>
                                        <option value="Left" {{ ($banner->position == 'Left') ? 'selected' : '' }}>Izquierda</option>
                                        <option value="Center" {{ ($banner->position == 'Center') ? 'selected' : '' }}>Centro</option>
                                        <option value="Right" {{ ($banner->position == 'Right') ? 'selected' : '' }}>Derecha</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="imageType" class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    @if($banner->image)
                                    <img class="img-fluid mt-2" src="{{ asset('front/img/banners/' . $banner->image ) }}" alt="{{ $banner->title }}">
                                    @endif
                                </div>
                                <div class="mb-3 col-md-12">
                                    ...
                                    <img class="img-fluid mt-2" src="{{ asset('front/img/banners/' . $banner->image_responsive ) }}" alt="{{ $banner->title }}">
                                    @endif
                                </div>
                            </div>
                        </div>
