        ...
        <ul class="list-unstyled topbar-nav float-end mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <h6 class="dropdown-item-text font-15 m-0 py-3 border-bottom d-flex justify-content-between align-items-center">
                        Correos <span class="badge bg-soft-primary badge-pill">3</span>
                    </h6>
                    <div class="notification-menu" data-simplebar>
                        <!-- item-->
                        <a href="#" class="dropdown-item py-3">
                            <small class="float-end text-muted ps-2">Hace 2 min</small>
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{URL::asset('assets/images/users/user-1.jpg')}}" alt="" class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                                    <h6 class="my-0 fw-normal text-dark">Tu pedido ha sido realizado</h6>
                                    <small class="text-muted mb-0">Texto de ejemplo de la impresión y la industria.</small>
                                </div>
                                <!--end media-body-->
                            </div>
                            <!--end media-->
                        ...
                        <!-- item-->
                        <a href="#" class="dropdown-item py-3">
                            <small class="float-end text-muted ps-2">Hace 10 min</small>
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                ...
                                <div class="media-body align-self-center ms-2 text-truncate">
                                    ...
                                    <small class="text-muted mb-0">Es un hecho establecido hace mucho tiempo que un lector.</small>
                                </div>
                                <!--end media-body-->
                            </div>
                            <!--end media-->
                        ...
                        <!-- item-->
                        <a href="#" class="dropdown-item py-3">
                            <small class="float-end text-muted ps-2">Hace 40 min</small>
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                                    <img src="{{URL::asset('assets/images/users/user-2.jpg')}}" alt="" class="thumb-sm rounded-circle">
                                </div>
                                <div class="media-body align-self-center ms-2 text-truncate">
                                    <h6 class="my-0 fw-normal text-dark">Tarea UX 3 completada.</h6>
                                    <small class="text-muted mb-0">Texto de ejemplo de la impresión.</small>
                                </div>
                                <!--end media-body-->
                            </div>
                            <!--end media-->
                        ...
                        <!-- item-->
                        <a href="#" class="dropdown-item py-3">
                            <small class="float-end text-muted ps-2">Hace 1 hr</small>
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
                        ...
                        <!-- item-->
                        <a href="#" class="dropdown-item py-3">
                            <small class="float-end text-muted ps-2">Hace 2 hrs</small>
                            <div class="media">
                                <div class="avatar-md bg-soft-primary">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg pt-0">
                    ...
                    <h6 class="dropdown-item-text font-15 m-0 py-3 border-bottom d-flex justify-content-between align-items-center">
                        Notificaciones <span class="badge bg-soft-primary badge-pill">2</span>
                    </h6>
                    <div class="notification-menu" data-simplebar>
                        <!-- item-->
                        <a href="#" class="dropdown-item py-3">
