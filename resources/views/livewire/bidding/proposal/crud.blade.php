                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="d-flex gap-4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="person_type_moral"
                                            value="moral" wire:model="person_type">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <div class="input-group">
                                        ...
                                        @else
                                            <input type="text" name="searchFolio" wire:model.live="searchSupplier"
                                    ...
                                    <div class="position-absolute drop-search p-3 pt-1 @if ($searchSupplier == null) d-none @endif"
                                        ...
                                        <label for="provisional_integer_id"
                                            class="col-form-label mb-1">Inspector</label>
