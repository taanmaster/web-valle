                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            @else
                                <input type="file"
                                    class="form-control @error('comprobante_pdf') is-invalid @enderror"
                                    wire:model="comprobante_pdf" accept=".pdf"
                    ...
                    <div class="d-flex gap-4 flex-wrap">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" wire:model="fundamento_legal"
                                value="Ley de Ingresos" id="fl_ley"
                                @if ($mode === 1) disabled @endif>
                            <label class="form-check-label" for="fl_ley">Ley de Ingresos</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" wire:model="fundamento_legal"
                                value="Disposiciones Administrativas" id="fl_disp"
                                @if ($mode === 1) disabled @endif>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <select class="form-select @error('concepto') is-invalid @enderror"
                                    wire:model.live="concepto" @if ($mode === 1) disabled @endif>
                                    <option value="">Selecciona una opción</option>
                                    <option value="Inhumaciones por quinquenio">Inhumaciones por quinquenio</option>
                                    <option value="Inhumaciones a perpetuidad">Inhumaciones a perpetuidad</option>
                                    <option value="Costo del terreno en panteón">Costo del terreno en panteón</option>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <select class="form-select @error('tipo') is-invalid @enderror"
                                    wire:model="tipo"
                                    @if ($mode === 1 || !$concepto) disabled @endif>
                                    <option value="">Selecciona una opción</option>
                                    @foreach ($this->tipoOptions as $opcion)
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input type="text"
                                    class="form-control @error('panteon_nombre') is-invalid @enderror"
                                    wire:model="panteon_nombre" @if ($mode === 1) disabled @endif>
                                <span class="input-group-text"><i class="bx bx-pencil"></i></span>
                            </div>
                            @error('panteon_nombre')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input type="text"
                                    class="form-control @error('cantidad_letra') is-invalid @enderror"
                                    wire:model="cantidad_letra" @if ($mode === 1) disabled @endif>
                                <span class="input-group-text"><i class="bx bx-pencil"></i></span>
                            </div>
                            @error('cantidad_letra')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
