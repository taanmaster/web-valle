...
@section('content')
    ...
    <div class="row layout-spacing">
        <div class="main-content">
            <form method="POST" action="{{ route('tourism.banners.update', $banner->id) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="row">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="text-right mt-4 mb-5">
                            ...
                            <hr>
                            <a href="{{ route('tourism.banners.index') }}" class="btn btn-secondary d-block">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
