...
<div class="row layout-spacing">
    <div class="main-content">
        ...
        <form method="POST" wire:submit="save" enctype="multipart/form-data">
            ...
            @if ($mode != 1)
                <div class="m-3 d-flex justify-content-end" style="gap: 12px">
                    <a href="{{ route('tourism.blog.admin.index') }}" style="max-width: 110px"
        ...
        @if ($mode == 2)
            ...
            <div class="col-md-12">
                <form action="{{ route('dropzone.tourism.blog.upload', $blog->id) }}" method="POST"
    ...
    @push('scripts')
        ...
        <script>
            ...
            const myDropzone = new Dropzone("#dropzoneForm", {
                url: "{{ route('dropzone.tourism.blog.upload', $blog->id) }}",
                headers: {
            ...
            function load_images() {
                $.ajax({
                    url: "{{ route('dropzone.tourism.blog.fetch', $blog->id) }}",
            ...
            $(document).on('click', '.remove_file', function() {
                ...
                $.ajax({
                    url: "{{ route('dropzone.tourism.blog.delete') }}",
                    type: 'POST',
                    data: {
