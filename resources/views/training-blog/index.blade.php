...
@section('title') Programa de Capacitación - Blog @endsection
@section('content')
        ...
        <div class="main-content">
            <div class="row align-items-center mb-4">
                <div class="col text-start">
                    <a href="{{ route('training_blog.admin.create') }}" class="btn btn-primary">Nueva Entrada</a>
                </div>
            </div>
            ...
            @if ($entries->count() == 0)
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box">
                            <div class="box-body">
                                <div class="text-center" style="padding: 80px 0 100px;">
                                    ...
                                    <a href="{{ route('training_blog.admin.create') }}"
