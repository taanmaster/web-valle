...
@slot('title') Contratista @endslot
@endcomponent
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-body">
                    <form method="POST" action="{{ route('contractor_checklists.store', $contractor->id) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="budget_item" name="budget_item">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="reserve_doc_pres" name="reserve_doc_pres">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="taxpayer_registration" name="taxpayer_registration">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="award_method" class="form-label">Modalidad De Adjudicación</label>
                                <input type="text" class="form-control" id="award_method" name="award_method">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="with_resources" class="form-label">Con Recursos</label>
                                <input type="checkbox" class="form-check-input" id="with_resources" name="with_resources">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="execution_annex" name="execution_annex">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="contract_signing_date" name="contract_signing_date">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="contract_validity_start" class="form-label">Vigencia Contrato - Inicia</label>
                                <input type="date" class="form-control" id="contract_validity_start" name="contract_validity_start">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="contract_validity_end" class="form-label">Vigencia Contrato - Termina</label>
                                <input type="date" class="form-control" id="contract_validity_end" name="contract_validity_end">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="validity_modification_start" class="form-label">Modificación De La Vigencia - Inicia</label>
                                <input type="date" class="form-control" id="validity_modification_start" name="validity_modification_start">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="validity_modification_end" class="form-label">Modificación De La Vigencia - Termina</label>
                                <input type="date" class="form-control" id="validity_modification_end" name="validity_modification_end">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="modification_agreement_amount" class="form-label">Convenio Modificatorio En Monto</label>
                                <input type="number" step="0.01" class="form-control" id="modification_agreement_amount" name="modification_agreement_amount">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="modification_agreement_time_start" name="modification_agreement_time_start">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="modification_agreement_time_end" class="form-label">Convenio Modificatorio En Tiempo - Termina</label>
                                <input type="date" class="form-control" id="modification_agreement_time_end" name="modification_agreement_time_end">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="estimated" class="form-label">Estimado</label>
                                <input type="number" step="0.01" class="form-control" id="estimated" name="estimated">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="sum" name="sum">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="advance_amortization" class="form-label">Amortización Del Anticipo</label>
                                <input type="number" step="0.01" class="form-control" id="advance_amortization" name="advance_amortization">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="net_scope" name="net_scope">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="subtotal_2" class="form-label">Subtotal 2</label>
                                <input type="number" step="0.01" class="form-control" id="subtotal_2" name="subtotal_2">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="iva_2" class="form-label">IVA 2</label>
                                <input type="number" step="0.01" class="form-control" id="iva_2" name="iva_2">
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="faism_2024_pays" name="faism_2024_pays">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="state_pays" class="form-label">Estado Paga</label>
                                <input type="number" step="0.01" class="form-control" id="state_pays" name="state_pays">
                            </div>
                            <div class="col-md-6 mb-3">
