...
<div class="row layout-spacing">
    <div class="main-content">
        <div class="row">
            <div class="col-md-12">
                <h3>Resultados de Búsqueda <div class="badge badge-info">{{ $suppliers->count() }}</div></h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-4">
                                <h4 class="mt-0 header-title mb-4">Listado de Proveedores</h4>
                            </div>
        
                            <div class="col-8 text-end">
                                @include('treasury_account_payable_suppliers.utilities._search_options')
                            </div>
                        </div>
