            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('supplier_checklists.create', ['supplier_id' => $supplier->id]) }}" class="btn btn-sm btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('supplier_checklists.show', $checklist->id) }}" class="btn btn-sm btn-outline-primary">
                                                    <i class="bx bx-show-alt"></i> Ver
                                                </a>
                                                <form method="POST" action="{{ route('supplier_checklists.destroy', $checklist->id) }}" style="display: inline-block;">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
