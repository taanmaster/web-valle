...
<div class="dropdown-menu">
    <form class="form-horizontal p-4" role="search" action="{{ route('trn_proposals.index') }}" method="GET">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="contain">Que contenga los términos...</label>
                    <input class="form-control" type="search" name="query" placeholder="Título de la convocatoria">
                </div>
            </div>
