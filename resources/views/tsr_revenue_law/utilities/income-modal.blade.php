<div class="modal fade" id="modalIncome" tabindex="-1" role="dialog" aria-labelledby="modalIncome" aria-hidden="true">
                ...
                <div class="modal-body pd-25">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="order_number" class="form-label">Tipo <span
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="order_number" class="form-label">Ley <span
                                    class="text-danger tx-12">*</span></label>
                            <input type="text" class="form-control" wire:model="law" name="law" required>
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="order_number" class="form-label">Total <span
                                    class="text-danger tx-12">*</span></label>
