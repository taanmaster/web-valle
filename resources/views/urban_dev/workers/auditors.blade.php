...
@slot('title') Directorio de Fiscalización @endslot
@endcomponent
    ...
    <div class="main-content">
        <div class="row align-items-center mb-4">
            <div class="col-md-8 text-start">
                <h4 class="mb-0">Directorio de Fiscalización</h4>
            ...
            <div class="col-md-4 text-end">
                <a href="{{ route('urban_dev.workers.create') }}" class="btn btn-success">
                    <i class='fas fa-plus-circle me-2'></i> Agregar Fiscalizador
                </a>
            </div>
        </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <div class="text-center" style="padding:80px 0px 100px 0px;">
                            ...
                            <h4>¡No hay fiscalizadores registrados!</h4>
