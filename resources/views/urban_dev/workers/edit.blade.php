...
@slot('title') Editar Trabajador @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <h4 class="box-title">Editar Trabajador</h4>
            </div>
            <div class="box-body">
                <form method="POST" action="{{ route('urban_dev.workers.update', $worker->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('employee_number') is-invalid @enderror" id="employee_number" name="employee_number" value="{{ old('employee_number', $worker->employee_number) }}" required placeholder="Ej. EMP-2025-001">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('position') is-invalid @enderror" id="position" name="position" value="{{ old('position', $worker->position) }}" required placeholder="Ej. Inspector de Obra">
                                        @error('position')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3" id="subcategory_container" style="display: none;">
                                        ...
                                        <select class="form-control @error('dependency_subcategory') is-invalid @enderror" id="dependency_subcategory" name="dependency_subcategory">
                                            <option value="">Seleccionar...</option>
                                            <option value="Inspector" {{ old('dependency_subcategory', $worker->dependency_subcategory) == 'Inspector' ? 'selected' : '' }}>Inspector</option>
                                            <option value="Perito" {{ old('dependency_subcategory', $worker->dependency_subcategory) == 'Perito' ? 'selected' : '' }}>Perito</option>
                                        </select>
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('issue_date') is-invalid @enderror" id="issue_date" name="issue_date" value="{{ old('issue_date', $worker->issue_date->format('Y-m-d')) }}" required>
                                        @error('issue_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('validity_date_start') is-invalid @enderror" id="validity_date_start" name="validity_date_start" value="{{ old('validity_date_start', $worker->validity_date_start->format('Y-m-d')) }}" required>
