...
@section('title') Bienestar Laboral - Blog @endsection
@section('content')
    @component('components.breadcrumb')
        @slot('li_1') Intranet @endslot
        @slot('li_2') Bienestar Laboral @endslot
        ...
        <div class="main-content">
            <div class="row align-items-center mb-4">
                <div class="col text-start">
                    <a href="{{ route('welfare_blog.admin.create') }}" class="btn btn-primary">Nueva Entrada</a>
                </div>
            </div>
                        ...
                        <div class="box">
                            <div class="box-body">
                                <div class="text-center" style="padding:80px 0px 100px 0px;">
                                    ...
                                    <a href="{{ route('welfare_blog.admin.create') }}"
            ...
            @else
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <livewire:general-blog.entries-table :type="'welfare'" />
                    </div>
                </div>
            @endif
        </div>
