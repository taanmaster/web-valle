...
@section('content')
    ...
    <div class="row layout-spacing">
        <div class="main-content">
            ...
            {{-- Acciones --}}
            <div class=" mb-3" style="gap:8px;">
                <a href="{{ route('welfare.admin.index') }}" class="btn btn-sm btn-secondary" style="width: fit-content">
                    &larr; Volver
                </a>
            </div>
            ...
            <div class="card mb-4"
                ...
                @if ($post->hero_img && $post->hero_img !== 'empty-image.jpg')
                    <img src="{{ asset('images/welfare-blog/' . $post->hero_img) }}"
